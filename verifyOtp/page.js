...
export default function VerifyOtp () {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#090707]">
      <div className="bg-[#030109] flex flex-col gap-5 border border-gray-700 h-[600px] shadow-lg rounded-2xl p-6 md:p-8 w-full max-w-md text-center transition-all">
        
        <Image src="/SynergyLogo-removebg-preview 1.svg" alt="Synergy Logo" height={117} width={117} className="self-center" />
        ...
        <div className="flex flex-col gap-10">
          ...
          <Link href="/forgot-password" className="text-[#0A1CB1] font-semibold text-sm">
